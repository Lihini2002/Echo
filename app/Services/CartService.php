...
class CartService {
     ...
     * @return void
     */
    public function add($id, $name, $price, $quantity, $description): void
    {
        $cartItem = $this->createCartItem($name, $price, $quantity, $description);
    ...
    protected function createCartItem(string $name, string $price, string $quantity, string $description): Collection
    {
